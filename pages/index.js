...
export default function Home() {
  const endpoints = [
    ...
    },
    {
      ...
      parameters: [
        ...
        {
          name: 'start_date',
          description: '*required* the starting date of the trip',
        },
        {
          name: 'end_date',
          description: '*required* the end date of the trip',
        },
      ],
    },
    {
  ...
  return (
    <div className={styles.container}>
      <Head>
        <title>LumenTrips API</title>
        <link rel="icon" href="/favicon.ico" />
      </Head>
      <main className={styles.main}>
        <h1 className={styles.title}>LumenTrips API</h1>
                ...
                <>
                  ...
                  <ul>
                    {endpoint.parameters.map((parameter, parameterIndex) => (
                      <li className={styles.list} key={parameterIndex}>
